    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 block block-primary">
                ...
                <h3>Reaktywność</h3>
                <p>Chcesz żeby Twoja strona wyglądała dobrze na ekranie PCeta, laptopa, tableta oraz smartfona? Chcesz
                    żeby strona automatycznie zmieniała rozmieszczenie elementów w zależności od dostępnego miejsca na
                    ekranie? Responsywność strony jest tym czego szukasz!</p>
            </div>
