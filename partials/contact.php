      ...
      <div class="container">
        <div class="form-row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control op-05 border-white" id="email" aria-describedby="emailPrepand"
        ...
        <div class="form-row">
          <div class="col-md-12 mb-3">
            ...
            <textarea class="form-control op-05 border-white" rows="5" id="message" placeholder="Napisz wiadomość"
              required></textarea>
          </div>
        </div>
